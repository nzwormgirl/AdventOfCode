...
modules <- read.table("2019/data/Day1.1.txt",header = F) 
...
* The sum of the fuel requirements for all modules is: `r `*
...
input <- as.vector(unlist(read.table("2019/data/Day2.1.txt",header = F,sep=",")))
# input[1+1] <- 12
# input[2+1] <- 2
# 
...
wires <- read.table("2019/data/Day3.txt",header = F,sep=",")
...
```{r}
input4 <- as.vector(unlist(read.table("2019/data/Day5.txt",header = F,sep=",")))
...
Map <- read.table("2019/data/Day6.txt",header = F,sep=",")
